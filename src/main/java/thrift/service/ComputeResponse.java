...
public class ComputeResponse implements org.apache.thrift.TBase<ComputeResponse, ComputeResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ComputeResponse> {
  ...
  public ComputeResponse setErrorMsg(@org.apache.thrift.annotation.Nullable java.lang.String errorMsg) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ERROR_NO:
      if (value == null) {
        ...
        setErrorNo((java.lang.Integer)value);
      }
      break;
    ...
    case COMPUTE_RET:
      if (value == null) {
        ...
        setComputeRet((java.lang.Long)value);
      }
      break;
  ...
  public int compareTo(ComputeResponse other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetErrorNo(), other.isSetErrorNo());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetComputeRet(), other.isSetComputeRet());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetComputeRet()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ComputeResponse(");
    boolean first = true;
