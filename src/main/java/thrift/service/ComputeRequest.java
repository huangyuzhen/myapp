...
public class ComputeRequest implements org.apache.thrift.TBase<ComputeRequest, ComputeRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ComputeRequest> {
   ...
   * @see ComputeType
   */
  public @org.apache.thrift.annotation.Nullable ComputeType computeType; // required
   ...
   * @see ComputeType
   */
  public ComputeRequest setComputeType(@org.apache.thrift.annotation.Nullable ComputeType computeType) {
    this.computeType = computeType;
    return this;
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetComputeType()) ? 131071 : 524287);
    if (isSetComputeType())
      hashCode = hashCode * 8191 + computeType.getValue();
  ...
  public int compareTo(ComputeRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetComputeType(), other.isSetComputeType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetComputeType()) {
